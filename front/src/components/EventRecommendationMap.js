              ...
              >
                <div className="event-card-content">
                  ...
                  <div className="event-details">
                    <p className="event-profitability">💰 수익성: {event.profitability}</p>
                    <p className="event-weather">🌤️ {event.weather}</p>
                    <p className="event-visitors">👥 예상 방문객: {event.expectedVisitors}</p>
