...
csv_file = "flask-server/data/서울시 문화행사 정보_UTF8.csv"
...
# 3. 수익 데이터 로드
df_places = pd.read_csv("flask-server/data/120개_장소별_예상수익.csv")
...
# 6. 저장
df_events.to_csv("flask-server/data/행사_샘플데이터_예상수익포함.csv", index=False, encoding="utf-8-sig")
